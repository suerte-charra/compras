            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col align-self-end text-end">
                            <button class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#agregar">Agregar Adquisión</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="container border">
                        <h5 class="text-center mt-2">Adquisiciones en proceso</h5>
